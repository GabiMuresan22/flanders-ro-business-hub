                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <a href="mailto:contact@ro-businesshub.be" className="text-romania-blue hover:underline">contact@ro-businesshub.be</a>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-800">+32 470 XX XX XX</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                ...
                <div className="md:col-span-2">
                  <div className="bg-white shadow-md rounded-lg p-6">
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <button
                        type="submit"
                        className="flex items-center justify-center bg-romania-blue text-white py-3 px-6 rounded-md hover:bg-blue-700 transition-colors"
                      >
