          ...
          <div className="relative max-w-xl mx-auto">
            <form onSubmit={handleSearch} role="search" aria-label="Search for businesses">
              <div className="flex">
                ...
                <button 
                  type="submit"
                  className="bg-romania-yellow hover:bg-yellow-400 text-gray-900 font-semibold py-4 px-4 sm:px-6 md:px-8 rounded-r-lg transition-colors focus:outline-none focus:ring-2 focus:ring-romania-yellow focus:ring-offset-2"
                  aria-label="Search"
                >
                  {t('hero.cta')}
                </button>
